...
def main():
    data_folder = os.getenv("VENET_DATA_FOLDER", "dataset/temporal3_data")
    ...
    model_variant = os.getenv("VENET_MODEL_VARIANT", "temporal3").strip().lower()
    ...
    output_dir = Path(os.getenv("VENET_OUTPUT_DIR", "runs/temporal3"))
    save_name = os.getenv("VENET_SAVE_NAME", "temporal3.pth")
