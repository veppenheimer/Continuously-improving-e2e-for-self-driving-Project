...
# ---------- 配置 ----------
ENGINE_PATH  = rospy.get_param('~engine_path', './ve_0526x_simplified_fp16.engine')
...
class MotionController:
    ...
    def sign_callback(self, msg):
        ...
        if msg.sign_type == 'limit' and self.limit_handled:
            return
        if msg.sign_type == 'crosswalk'and self.crosswalk_handled:
            return
            ...
            if self.current_action:
                ...
                if self.current_action in ('stop1', 'stop2'):
                    if elapsed < self.action_duration:
                        ...
                        self.crosswalk_handled = True # 必须先红灯
                        self.current_action = None
                        self.current_sign = None
                        continue
