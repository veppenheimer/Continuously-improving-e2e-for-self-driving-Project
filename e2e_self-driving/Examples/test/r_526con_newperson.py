...
class MotionController:
    def __init__(self):
        ...
        self.stop_duration_person = rospy.get_param('~stop_duration_person', 0.0)
   ...
   #      {"duration": 0.49, "linear": 0.5, "angular": 0.0},
    ...
    def sign_callback(self, msg):
        ...
        if msg.sign_type == 'limit' and self.limit_handled:
            return
        if msg.sign_type == 'crossing_walk'and self.crosswalk_handled == True:
            return
    ...
    def spin(self):
        while not rospy.is_shutdown():
            ...
            if self.current_action is None and self.sign_queue:
                ...
                if sign == "crossing_walk" and self.crosswalk_handled == True:
                ...
                if sign == 'red':
                    ...
                    continue
                elif sign == 'crossing_walk' and  self.crosswalk_handled == False:
