...
DEFAULT_RUN_DIR = ROOT / "training_runs" / "mobilenet_v2_temporal3_adapter_proxy_existing_source_20260419_002245"
DEFAULT_CKPT = DEFAULT_RUN_DIR / "best_ve2_mobilenet_v2_temporal3_adapter_proxy_existing_source.pth"
DEFAULT_OUT = ROOT / "output" / "model_visualization" / "temporal3_mobilenet_v2"


def _load_net_module():
    module_path = ROOT / "e2e_self-driving" / "Net" / "models.py"
